export default function OVDivider() {
  return (
    <svg
      width="280"
      height="180"
    ...
    >
      ...
      <rect x="70" y="58" width="57" height="4" rx="2" fill="var(--el-border-color-dark)" />
      <rect x="70" y="82" width="57" height="4" rx="2" fill="var(--el-border-color-dark)" />
      <rect x="70" y="106" width="57" height="4" rx="2" fill="var(--el-border-color-dark)" />
      <line
        x1="68"
        y1="71.6"
        x2="212"
