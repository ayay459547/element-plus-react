export default function OVImage() {
  return (
    <svg
      width="280"
      height="180"
    ...
    >
      ...
      <g filter="url(#filter0_d_13239_209071)">
        <rect x="108" y="66" width="64" height="48" rx="4" fill="var(--el-fill-color-blank)" />
        <rect
          x="109.5"
          y="67.5"
          width="61"
      ...
      <g mask="url(#mask0_13239_209071)">
        <rect x="106.72" y="103.76" width="66.56" height="16.64" fill="var(--el-color-primary)" />
        <path
