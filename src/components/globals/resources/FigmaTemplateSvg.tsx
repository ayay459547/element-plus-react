import styles from './FigmaTemplateSvg.module.scss'

export default function FigmaTemplateSvg() {
  return (
    ...
    >
      ...
      />
      <path className={styles['st3']} d="M60,28v12h6c3.3,0,6-2.7,6-6l0,0c0-3.3-2.7-6-6-6H60z" />
      <path
      ...
      />
      <path className={styles['st6']} d="M5,74h110v10c0,1.1-0.9,2-2,2H7c-1.1,0-2-0.9-2-2V74z" />
      <circle className={styles['st7']} cx="60" cy="80" r="2" />
      <path
