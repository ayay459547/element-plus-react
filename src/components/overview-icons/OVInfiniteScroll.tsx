export default function OVInfiniteScroll() {
  return (
    <svg
      width="280"
      height="180"
    ...
    >
      ...
      <rect x="96" y="75" width="84" height="8" rx="1" fill="var(--el-color-primary-light-8)" />
      <rect
        x="96"
        y="89"
        width="84"
      ...
      <rect x="186" y="105" width="4" height="15" rx="2" fill="var(--el-color-primary)" />
