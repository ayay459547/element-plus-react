export default function OVCollapse() {
  return (
    <svg
      width="280"
      height="180"
    ...
    >
      ...
      <g filter="url(#filter0_d_13239_209025)">
        <rect x="65" y="52" width="150" height="77" rx="2" fill="var(--el-fill-color-blank)" />
        <rect
          x="64.7"
          y="51.7"
          width="150.6"
      ...
      <rect x="65" y="72" width="150" height="35" fill="var(--el-border-color-light)" />
      <rect x="73" y="60" width="36" height="4" rx="2" fill="var(--el-border-color-dark)" />
      <rect x="73" y="80" width="36" height="4" rx="2" fill="var(--el-color-primary)" />
      <rect x="73" y="95" width="91" height="4" rx="2" fill="var(--el-border-color-dark)" />
      <path
      ...
      <line
        ...
        strokeWidth="0.5"
      />
      <rect x="73" y="117" width="36" height="4" rx="2" fill="var(--el-border-color-dark)" />
      <path
