export default function OVSplitter() {
  return (
    <svg
      width="280"
      height="180"
    ...
    >
      ...
      <g clipPath="url(#clip0_2477_1001)">
        ...
        />
        <rect x="165" y="63" width="20" height="4" rx="2" fill="var(--el-color-primary)" />
        <rect x="165" y="70" width="4" height="4" rx="2" fill="var(--el-color-primary-light-5)" />
        <rect x="172" y="70" width="21" height="4" rx="2" fill="var(--el-color-primary-light-5)" />
        <rect x="172" y="77" width="21" height="4" rx="2" fill="var(--el-color-primary-light-5)" />
        <path
