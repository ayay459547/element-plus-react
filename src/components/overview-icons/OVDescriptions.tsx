export default function OVDescriptions() {
  return (
    <svg
      width="280"
      height="180"
    ...
    >
      ...
      <rect x="71" y="78" width="36" height="4" rx="2" fill="var(--el-color-primary)" />
      <rect x="146" y="78" width="36" height="4" rx="2" fill="var(--el-border-color-dark)" />
      <rect x="71" y="110" width="62" height="4" rx="2" fill="var(--el-border-color-dark)" />
      <path
        d="M65 60C65 58.8954 65.8954 58 67 58H213C214.105 58 215 58.8954 215 60V70H65V60Z"
        fill="var(--el-border-color-light)"
      />
      <rect x="146" y="63" width="12" height="2" rx="1" fill="var(--el-border-color-dark)" />
      <rect x="71" y="63" width="12" height="2" rx="1" fill="var(--el-border-color-dark)" />
      <path d="M65 90H215V102H65V90Z" fill="var(--el-border-color-light)" />
      <rect x="71" y="95" width="12" height="2" rx="1" fill="var(--el-border-color-dark)" />
      <line
        x1="140.25"
        y1="58"
        x2="140.25"
